<?php 
	...
	{
		$c_id = $_POST['c_id'];
		$sel = "select * from cake_master JOIN category ON category.c_id = cake_master.c_id JOIN subcategory ON subcategory.s_id = cake_master.s_id where cake_master.`c_id` = '$c_id'";
