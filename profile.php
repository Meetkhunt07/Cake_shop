		...
		<div class="row" >
			<div class="col-lg-6" style="margin: 0 300px;">
				...
				<?php } ?>
					<form method="post">
						<label>Name :</label>
						<input require type="text" name="name" value="<?php if(isset($record['name'])) { echo $record['name']; } ?>">
							
					
						<label>Email :</label>
						<input require type="email" name="email" value="<?php if(isset($record['email'])) { echo $record['email']; } ?>">

						<label>Contact No :</label>
						<input require type="text" name="contact_no" value="<?php if(isset($record['contact_no'])) { echo $record['contact_no']; } ?>">
